...
class Layer {
 public:
  ...
  virtual bool set_data_labels(int* labels, int idx_start, int idx_end) { return false; };
  // Set position to seek for data in this layer, added by Jianwei Yang @09/28/2015
  virtual bool set_data_pos(int pos) { return false; };
  // Get groundtruth labels for data in this layer
  virtual int* get_data_gtlabels() { return 0; };
  // Get current position
  virtual int get_data_pos() { return 0; };
  // Get current position
  virtual int get_data_size() { return 0; };
  // Get mini_batch_size
  virtual int get_data_minibatch_size() { return 0; };
