...
class Layer {
 public:
  ...
  /*
    * @brief Set data labels fro idx_start to idx_end
  ...
  */
  ...
  /*
  * @brief Set data position to pos
  * added by Jianwei Yang @ 09/28/2015
  */
  ...
  /*
  * @brief get data size
  * added by Jianwei Yang @ 09/29/2015
  */
  ...
  /*
  * @brief get data groundtruth labels
  * added by Jianwei Yang @ 09/29/2015
  */
